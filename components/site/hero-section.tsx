  ...
  return (
    ...
    >
      <div className="relative aspect-square min-h-[340px] min-[810px]:aspect-[26/31]">
        <div className="absolute inset-0 rotate-[-9deg] scale-[0.93] rounded-[22px] border border-black/[0.06] bg-white opacity-95 shadow-[0_30px_60px_-32px_rgb(0_0_0/0.22)] transition-transform duration-[700ms] ease-[var(--ease-out-expo)] will-change-transform group-hover/deck:rotate-[-7deg]" />
        <div className="absolute inset-[4%] rotate-[4deg] scale-[0.93] rounded-[22px] border border-black/[0.07] bg-gradient-to-br from-white via-white to-neutral-50 shadow-[var(--shadow-card)] ring-1 ring-black/[0.04] transition-transform duration-[620ms] ease-[var(--ease-out-expo)] will-change-transform group-hover/deck:rotate-[2deg]" />
        <div className="absolute inset-[14%_10%] flex flex-col items-center justify-center rounded-[18px] border border-black/[0.055] bg-[#eaeaea]/90 p-8 text-center shadow-[inset_0_1px_0_rgb(255_255_255/0.46)] backdrop-blur-[6px]">
          <BrandMark />
          <p className="mt-4 font-display-mono text-[10px] uppercase tracking-[0.22em] text-muted">
            Design queue preview
          </p>
          <div className="mt-9 h-28 w-[88%] rounded-xl bg-black/[0.05] shadow-inner" />
        </div>
      </div>
    </div>
  );
